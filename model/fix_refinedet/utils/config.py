def get_feature_sizes(input_size, tcb_layer_num, use_extra_layer):
    ...
    if tcb_layer_num == 4 and use_extra_layer == True:
        return [input_size / 8, input_size / 16, input_size / 32, input_size / 64]
    elif tcb_layer_num == 4 and use_extra_layer == False:
        return [input_size / 4, input_size / 8, input_size / 16, input_size / 32]
    elif tcb_layer_num == 5 and use_extra_layer == True:
        return [input_size / 4, input_size / 8, input_size / 16, input_size / 32, input_size / 64]
    elif tcb_layer_num == 5 and use_extra_layer == False:
        return [input_size / 2, input_size / 4, input_size / 8, input_size / 16, input_size / 32]
    elif tcb_layer_num == 6 and use_extra_layer == True:
        return [input_size / 2, input_size / 4, input_size / 8, input_size / 16, input_size / 32, input_size / 64]
    else:
